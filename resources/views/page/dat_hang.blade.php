...
<div class="container">
    <div id="content">
        ...
        <form action="{{route('datHang')}}" method="post" class="beta-form-checkout">
                @csrf;
                <div class="row"><h3> @if(Session::has('thong bao')){{Session::get('thong bao')}}@endif</h3></div>
        <div class="row">
                <div class="col-sm-6">
                    <h4>Đặt hàng</h4>
                    ...
                    <div class="your-order">
                        ...
                        <div class="your-order-body" style="padding: 0px 10px">
                            ...
                            <div class="your-order-item">
                                ...
                                <div class="pull-right">
                                    <h5 class="color-black">@if(Session::has('cart')){{number_format($totalPrice)}}@endif</h5>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
